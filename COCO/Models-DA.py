...
if __name__ == "__main__":
    ...
    for altered_setup in ['box-True-default', 'box-True-paint']:

        save_extension = '{}-[{}]/{}'.format(model_class, labeler_class, altered_setup)
        ...
        dataloaders = {x: my_dataloader(datasets[x], num_workers = num_workers) for x in ['train', 'val']}
